            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="group relative">
                ...
                <div className="relative p-8 rounded-2xl bg-slate-900/30 border border-slate-800/50 hover:border-slate-700 transition-all">
                  ...
                  <p className="text-slate-400 leading-relaxed">
                    Setiap perspektif bernilai. Kami percaya kekuatan sejati
                    muncul ketika berbagai keahlian bersinergi untuk tujuan
                    bersama.
                  </p>
                </div>
              </div>
              ...
              <div className="group relative">
                ...
                <div className="relative p-8 rounded-2xl bg-slate-900/30 border border-slate-800/50 hover:border-slate-700 transition-all">
                  ...
                  <p className="text-slate-400 leading-relaxed">
                    Tidak puas dengan status quo. Kami terus mengeksplorasi
                    pendekatan baru untuk membuat pembelajaran lebih efektif dan
                    engaging.
                  </p>
                </div>
              </div>
              ...
              <div className="group relative">
                ...
                <div className="relative p-8 rounded-2xl bg-slate-900/30 border border-slate-800/50 hover:border-slate-700 transition-all">
                  ...
                  <p className="text-slate-400 leading-relaxed">
                    Teknologi tanpa tujuan adalah kosong. Kami fokus menciptakan
                    solusi yang memberi nilai nyata bagi pendidikan dan masa
                    depan.
                  </p>
                </div>
              </div>
