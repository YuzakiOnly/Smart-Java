...
export default function Footer() {
  return (
    <footer className="relative bg-slate-950 border-t border-white/10">
      <div className="absolute inset-x-0 -top-32 h-32 bg-linear-to-r from-emerald-500/10 via-sky-500/10 to-transparent blur-3xl pointer-events-none" />

      <div className="relative max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14 mb-16">

          <div>
            <h3 className="text-2xl font-semibold bg-linear-to-r from-emerald-400 to-sky-400 bg-clip-text text-transparent mb-4">
              Smart-Java Game
            </h3>
